    ...
    <article className="group rounded-3xl bg-card overflow-hidden shadow-soft border border-border flex flex-col transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_40px_-18px_rgba(62,39,35,0.28)]">
      ...
      <div className="p-5 sm:p-6 flex flex-col flex-1 gap-2">
        <div className="flex items-start justify-between gap-2">
          <h3 className="font-display text-xl text-chocolate leading-snug">
            {p.name}
          </h3>

          <span
            className={`text-[11px] uppercase tracking-wide px-2 py-1 rounded-full shrink-0 ${
              p.available
                ? "bg-pink-soft text-chocolate"
        ...
        <p className="text-base text-chocolate-soft leading-relaxed">
          {p.description}
        </p>
